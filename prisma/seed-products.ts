  ...
  const baseProducts = await Promise.all([
    prisma.baseProduct.create({
      data: {
        ...
        brand: 'DJI',
        sku: '1000009061',
        image: 'https://cdnx.jumpseller.com/picslab-store/image/60281130/resize/306/306?1739884710'
      },
    }),
    prisma.baseProduct.create({
      data: {
        ...
        brand: 'CANON',
        sku: '6536C003',
        image: 'https://cdnx.jumpseller.com/picslab-store/image/51477920/resize/306/306?1723045107'
      },
    }),
    prisma.baseProduct.create({
      data: {
        ...
        brand: 'SIGMA',
        sku: 'SG20269',
        image: 'https://cdnx.jumpseller.com/picslab-store/image/30117871/resize/306/306?1670600713'
      },
    }),
  ]);
  ...
  await Promise.all([
    ...
    prisma.product.create({
      data: {
        ...
        outOfStock: false,
        sku: '1000009061',
        image: 'https://davidandjoseph.cl/image/cache/catalog/DJI/1000009061-250x250.jpg',
        brandId: brandsId['DJI'],
        webpageId: 4,
        baseProductId: baseProductId['1000009061'],
      },
    ...
    prisma.product.create({
      data: {
        ...
        outOfStock: true,
        sku: '1000009061',
        image: 'https://cdnx.jumpseller.com/rincon-fotografico/image/60111027/resize/610/610?1739454408',
        brandId: brandsId['DJI'],
        webpageId: 2,
        baseProductId: baseProductId['1000009061'],
      },
    ...
    prisma.product.create({
      data: {
        ...
        outOfStock: true,
        sku: '6536C003',
        image: 'https://apertura.cl/tienda/47153-large_default/canon-eos-r5-mark-ii-mirrorless-.jpg',
        brandId: brandsId['CANON'],
        webpageId: 3,
        baseProductId: baseProductId['6536C003'],
      },
    ...
    prisma.product.create({
      data: {
        ...
        outOfStock: true,
        sku: 'SG20269',
        image: 'https://apertura.cl/tienda/29927-large_default/sigma-56mm-f14-dc-dn-contemporary-lente-para-fujifilm-x.jpg',
        brandId: brandsId['SIGMA'],
        webpageId: 3,
        baseProductId: baseProductId['SG20269'],
      },
